...
import stringLog.NewArrayStringLog;

public class NewZoombinis
	 ...
	 //CONSTRUCTOR:====================
	 public NewZoombinis(int ss, int nn, int mm, String ppath)
